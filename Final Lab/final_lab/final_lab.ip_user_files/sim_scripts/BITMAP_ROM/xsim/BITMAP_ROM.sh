...
#
# Script generated by Vivado on Mon Nov 24 11:05:34 -0700 2025
# SW Build 5239630 on Fri Nov 08 22:35:27 MST 2024
#
# Copyright 1986-2022 Xilinx, Inc. All Rights Reserved.
# Copyright 2022-2024 Advanced Micro Devices, Inc. All Rights Reserved. 
#
# Filename     : BITMAP_ROM.sh
...
#
# Usage        : BITMAP_ROM.sh
#                BITMAP_ROM.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                BITMAP_ROM.sh [-reset_run]
#                BITMAP_ROM.sh [-reset_log]
#                BITMAP_ROM.sh [-help]
#
...
# script info
echo -e "BITMAP_ROM.sh - Script generated by export_simulation (Vivado v2024.2 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./BITMAP_ROM.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 2  -L xil_defaultlib -L blk_mem_gen_v8_4_9 -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot BITMAP_ROM xil_defaultlib.BITMAP_ROM xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim BITMAP_ROM -key {Behavioral:sim_1:Functional:BITMAP_ROM} -tclbatch cmd.tcl -log simulate.log
}
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb BITMAP_ROM.wdb xsim.dir libdpi.so)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./BITMAP_ROM.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: BITMAP_ROM.sh [-help]\n\
Usage: BITMAP_ROM.sh [-step]\n\
Usage: BITMAP_ROM.sh [-lib_map_path]\n\
Usage: BITMAP_ROM.sh [-reset_run]\n\
Usage: BITMAP_ROM.sh [-reset_log]\n\
Usage: BITMAP_ROM.sh [-keep_index]\n\
Usage: BITMAP_ROM.sh [-noclean_files]\n\n\
