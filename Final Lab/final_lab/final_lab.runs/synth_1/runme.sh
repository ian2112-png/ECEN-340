...
HD_PWD='C:/Users/ian2112/final_lab/final_lab.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log TOP_1080P_VGA.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source TOP_1080P_VGA.tcl
