...
HD_PWD='C:/Users/slricks340/Desktop/ECEN 340 Seth Ricks Ian Fleming/ECEN-340/Final Lab/Joystick/Joystick/Joystick.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log joystick_main.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source joystick_main.tcl
