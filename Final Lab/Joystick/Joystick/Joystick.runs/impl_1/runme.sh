...
HD_PWD='C:/Users/slricks340/Desktop/ECEN 340 Seth Ricks Ian Fleming/ECEN-340/Final Lab/Joystick/Joystick/Joystick.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log joystick_main.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source joystick_main.tcl -notrace
